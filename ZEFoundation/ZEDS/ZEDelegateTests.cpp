...
ZETestSuiteAdd(ZEDelegate)
{
	ZETestItemAdd(NULLDelegate)
	{
		ZEDelegate<SYNTAX> Delegate;
		CHECK(Delegate.IsNull());
		CHECK(Delegate == false);
		CHECK(!Delegate == true);
	}

	ZETestItemAdd(IsNull)
	{

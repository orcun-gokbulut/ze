...
macro (ze_debugging_init)
	...
	if (ZEBUILD_DEBUG_ENABLE)
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS "$<$<CONFIG:Debug>:ZE_DEBUG_ENABLE>")
		
		if (ZEBUILD_DEBUG_BREAK_ON_ERROR)
			set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS "$<$<CONFIG:Debug>:ZE_DEBUG_BREAK_ON_ERROR>")
		endif()

		if (ZEBUILD_DEBUG_BREAK_ON_WARNING)
			set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS "$<$<CONFIG:Debug>:ZE_DEBUG_BREAK_ON_WARNING>")
		endif()

		if (ZEBUILD_DEBUG_MEMORY_CHECK_ENABLE)
			set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS "$<$<CONFIG:Debug>:ZE_DEBUG_MEMORY_CHECKS_ENABLE>")
		endif()
	endif()
endmacro()

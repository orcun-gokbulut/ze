...
macro (ze_debugging_init)
	...
	if (ZEBUILD_DEBUG_ENABLE)
		set_property(DIRECTORY PROPERTY COMPILE_DEFINITIONS_DEBUG ZE_DEBUG_ENABLE)
		
		if (ZEBUILD_DEBUG_BREAK_ON_ERROR)
			set_property(DIRECTORY PROPERTY COMPILE_DEFINITIONS_DEBUG ${COMPILE_DEFINITIONS_DEBUG} ZE_DEBUG_BREAK_ON_ERROR)
		endif()

		if (ZEBUILD_DEBUG_BREAK_ON_WARNING)
			set_property(DIRECTORY PROPERTY COMPILE_DEFINITIONS_DEBUG ${COMPILE_DEFINITIONS_DEBUG} ZE_DEBUG_BREAK_ON_WARNING)
		endif()

		if (ZEBUILD_DEBUG_MEMORY_CHECK_ENABLE)
			set_property(DIRECTORY PROPERTY COMPILE_DEFINITIONS_DEBUG ${COMPILE_DEFINITIONS_DEBUG} ZE_DEBUG_MEMORY_CHECKS_ENABLE)
		endif()
	endif()
endmacro()

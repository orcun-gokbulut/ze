...
function (ze_get_dependency_list_combined)
	parse_arguments(PARAMETER "TARGET;RETURN" "" ${ARGV})

	get_property(VARIABLE_DEPENDENCIES TARGET ${PARAMETER_TARGET} PROPERTY ZEBUILD_DEPENDENCIES_COMBINED)
	if (NOT VARIABLE_DEPENDENCIES)
		ze_get_dependency_list(TARGET ${PARAMETER_TARGET} RETURN VARIABLE_DEPENDENCIES)
		set_property(TARGET ${PARAMETER_TARGET} PROPERTY ZEBUILD_DEPENDENCIES_COMBINED ${VARIABLE_DEPENDENCIES})
	endif()
	
	set(${PARAMETER_RETURN} ${VARIABLE_DEPENDENCIES} PARENT_SCOPE)
endfunction()

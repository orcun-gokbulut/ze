...
macro(ze_platform_generate_definitions)
	...
	if (ZEBUILD_PLATFORM_UNIX)
		set(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_UNIX)
	endif()
	
	if (ZEBUILD_PLATFORM_WINDOWS)
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_WINDOWS)
	endif()
    
    if (ZEBUILD_PLATFORM_DARWIN)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_DARWIN)
    endif()

	if (ZEBUILD_PLATFORM_BSD)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_BSD)
    endif()

	if (ZEBUILD_PLATFORM_LINUX)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_LINUX)
    endif()

	if (ZEBUILD_PLATFORM_ANDROID)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_ANDROID)
    endif()

	if (ZEBUILD_PLATFORM_IOS)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_IOS)
    endif()

	if (ZEBUILD_PLATFORM_XBOX360)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_XBOX360)
    endif()

	if (ZEBUILD_PLATFORM_PS3)      
		set_property(DIRECTORY ${CMAKE_SOURCE_DIR} APPEND PROPERTY COMPILE_DEFINITIONS ZE_PLATFORM_PS3)
    endif()
endmacro()

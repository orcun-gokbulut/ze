...
macro (ze_configure_platform)
	...
	if (ZEBUILD_PLATFORM MATCHES "MacOSX")
		if (NOT DEFINED ZEBUILD_PLATFORM_IPHONE)
			set (ZEBUILD_PLATFORM_IPHONE FALSE CACHE BOOL "Build as iPhone Application")
		endif()

		if (NOT DEFINED ZEBUILD_PLATFORM_IPHONE_SIMULATOR)
			set (ZEBUILD_PLATFORM_IPHONE_SIMULATOR FALSE CACHE BOOL "Build as iPhone Simulator Application")
		endif()
	endif()
		
	if (ZEBUILD_PLATFORM_IPHONE OR ZEBUILD_PLATFORM_IPHONE_SIMULATOR)
		set(LIBRARY_OUTPUT_PATH "${CMAKE_BINARY_DIR}/lib\$\(EFFECTIVE_PLATFORM_NAME\)")
    ...
    if (ZEBUILD_PLATFORM MATCHES "iOS" OR ZEBUILD_PLATFORM MATCHES "MacOSX")      

...
function(ze_add_executable)
	...
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY PDB_OUTPUT_DIRECTORY "${CMAKE_BUILD_DIR}/Symbols")
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY OUTPUT_NAME_DEBUG "${PARAMETER_TARGET}-Debug")

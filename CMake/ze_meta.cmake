...
function(ze_meta_compiler)
	...
	if (PARAMETER_TARGET)
		get_property(VARIABLE_TARGET_DEFINITIONS TARGET ${PARAMETER_TARGET} PROPERTY COMPILE_DEFINITIONS)
		get_property(VARIABLE_TARGET_INCLUDE_DIRECTORIES TARGET ${PARAMETER_TARGET} PROPERTY INCLUDE_DIRECTORIES)
	endif()
	
	if (ZEBUILD_PLATFORM_WINDOWS)
		list(APPEND VARIABLE_DEFINITIONS "WIN32")
		if (ZEBUILD_PLATFORM_ARCHITECTURE_X64)
			list(APPEND VARIABLE_DEFINITIONS "WIN64")
		endif()
	endif()
	
	list(APPEND VARIABLE_DEFINITIONS ${VARIABLE_TARGET_DEFINITIONS})
	list(APPEND VARIABLE_INCLUDE_DIRECTORIES ${VARIABLE_TARGET_INCLUDE_DIRECTORIES})

...
function(ze_add_executable)
	...
	if (PARAMETER_CONSOLE)
		...
		elseif ("${ZEBUILD_PLATFORM}" MATCHES "MacOSX" OR "${ZEBUILD_PLATFORM}" MATCHES "iOS" )
	...
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY RUNTIME_OUTPUT_DIRECTORY ${CMAKE_SOURCE_DIR}/Rundir)
...
function(ze_add_plugin)
	parse_arguments(PARAMETER "SOURCES;LIBS;INSTALL_DESTINATION;INSTALL_COMPONENT;${ze_check_parameters}" "INSTALL;DLL" ${ARGV})
	...
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY FOLDER ${ZEBUILD_PROJECT_FOLDER})
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY ZEBUILD_LIBS ${PARAMETER_LIBS})
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY RUNTIME_OUTPUT_DIRECTORY ${CMAKE_SOURCE_DIR}/Rundir/Plugins)
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY RUNTIME_OUTPUT_DIRECTORY_DEBUG ${CMAKE_SOURCE_DIR}/Rundir/Plugins)
	set_property(TARGET ${PARAMETER_TARGET} PROPERTY RUNTIME_OUTPUT_DIRECTORY_RELEASE ${CMAKE_SOURCE_DIR}/Rundir/Plugins)

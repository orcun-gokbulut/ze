...
/*******************************************************************************
 Zinek Engine - ZEDImageFileExtension.h
 ------------------------------------------------------------------------------
...
#ifndef __ZED_IMAGE_FILE_EXTENSION_H__
...
class ZEDImageFileExtensionDescription : public ZEDExtensionDescription
{
	public:
		...
		virtual ZEDExtension*				CreateInstance();
											...
											ZEDImageFileExtensionDescription();
};

class ZEDImageFileExtension : public ZEDFileExtension
{
	friend class ZEDImageFileExtensionDescription;

	private:
			QList<QString>					FileFormats;

											ZEDImageFileExtension();

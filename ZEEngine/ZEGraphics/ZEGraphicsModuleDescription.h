...
/*******************************************************************************
 Zinek Engine - ZEGraphicsModuleDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_GRAPHICS_MODULE_DESCRIPTION_H__
#define __ZE_GRAPHICS_MODULE_DESCRIPTION_H__

#include "ZECore/ZEModuleDescription.h"

class ZEGraphicsModuleDescription : public ZEModuleDescription
{
	public:

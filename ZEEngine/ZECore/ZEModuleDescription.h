...
/*******************************************************************************
 Zinek Engine - ZEModuleDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_MODULE_DESCRIPTION_H__
#define __ZE_MODULE_DESCRIPTION_H__
...
#define ZE_MA_EXTERNAL			2
#define ZE_MA_SAFE				4
#define ZE_MA_DEBUG				8
#define ZE_MA_COMPATIBLE		16
#define ZE_MA_VALIDATED			32
...
{
	public:
		virtual ZEModuleDescription*	GetBaseModuleDescription() = 0;

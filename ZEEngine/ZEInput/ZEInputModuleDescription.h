...
/*******************************************************************************
 Zinek Engine - ZEInputModuleDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_INPUT_MODULE_DESCRIPTION_H__
#define __ZE_INPUT_MODULE_DESCRIPTION_H__

#include "ZECore/ZEModuleDescription.h"

class ZEInputModuleDescription : public ZEModuleDescription
{
	public:

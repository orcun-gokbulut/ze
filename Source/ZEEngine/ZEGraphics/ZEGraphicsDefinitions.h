...
#define ZE_MAX_VERTEX_LAYOUT_ELEMENT		16
#define ZE_MAX_VERTEX_BUFFER_SLOT			16
#define ZE_MAX_SAMPLER_SLOT					16
#define ZE_MAX_TEXTURE_SLOT					32
#define ZE_MAX_CONSTANT_BUFFER_SLOT			14
#define ZE_MAX_VIEWPORT_SLOT				16
#define ZE_MAX_SCISSOR_SLOT					16

#define	ZE_STATE_POOL_CACHE_CAPACITY		128

#define	ZE_MAX_SHADOW_COPY_COUNT			5
#define	ZE_RENDER_BUFFER_COUNT				2

...
void ZEFixedMaterial::ReadFromFile(const ZEString& FilePath)
{
	...
	ZEValue WireFrame, TwoSided, ZCull, ZWrite;

	// Material properties
	ZEValue Opacity, AlphaCullLimit, DetailMapTiling, DetailDistanceFull, 
	...
	// Textures
	ZEValue BaseMap, NormalMap, ParallaxMap, SpecularMap, EmissiveMap, OpacityMap, 
		DetailBaseMap, DetailNormalMap, EnvironmentMap, LightMap;

	// Shader components
	ZEValue AmbientEnabled, DiffuseEnabled, BaseMapEnabled, NormalMapEnabled,

...
void ZEFixedMaterial::ReadFromFile(const ZEString& FilePath)
{
	...
	ZEValue ConfigurationNameValue, WireFrameValue, TwoSidedValue, TransparencyModeValue, LightingEnabledValue, ShadowCasterValue, ShadowReceiverValue;

	// Material properties
	ZEValue OpacityValue, OpacityComponentValue, AlphaCullLimitValue, DetailMapTilingValue, DetailDistanceFullValue, 
	...
	// Textures
	ZEValue BaseMapValue, BaseMapAddressModeUValue, BaseMapAddressModeVValue, NormalMapValue, NormalMapAddressModeUValue, NormalMapAddressModeVValue, 
	...
	// Shader components
	ZEValue AmbientEnabledValue, GlobalAmbientEnabledValue, DiffuseEnabledValue, BaseMapEnabledValue, NormalMapEnabledValue,

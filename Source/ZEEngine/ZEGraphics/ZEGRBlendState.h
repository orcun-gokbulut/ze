...
{	
	...
	ZEGR_BO_ONE					= 1,
	ZEGR_BO_SRC_COLOR			= 2,
	ZEGR_BO_INV_SRC_COLOR		= 3,
	ZEGR_BO_SRC_ALPHA			= 4,
	ZEGR_BO_INV_SRC_ALPHA		= 5,
	ZEGR_BO_DEST_ALPHA			= 6,
	ZEGR_BO_INV_DEST_ALPHA		= 7,
	ZEGR_BO_DEST_COLOR			= 8,
	ZEGR_BO_INV_DEST_COLOR		= 9,
	ZEGR_BO_SRC_ALPHA_SAT		= 10,
	ZEGR_BO_BLEND_FACTOR		= 11,
	ZEGR_BO_INV_BLEND_FACTOR	= 12,
	ZEGR_BO_SRC1_COLOR			= 13,
	ZEGR_BO_INV_SRC1_COLOR		= 14,
	ZEGR_BO_SRC1_ALPHA			= 15,
	ZEGR_BO_INV_SRC1_ALPHA		= 16
};

...
bool ZED3D9TerrainMaterial::SetupGBufferPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderCommand) const
{
	...
	GetDevice()->SetVertexShaderConstantF(15, (float*)&ZEVector4(BlendTreshold * 2.0f * ChunkSize, (1.0f - BlendTreshold) * 2.0f * ChunkSize, 0.0f, 0.0f), 1);
...
bool ZED3D9TerrainMaterial::SetupForwardPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderCommand) const
{
	...
	GetDevice()->SetVertexShaderConstantF(14, (float*)&ZEVector4(TextureOffset.x, TextureOffset.y, TextureScale.x, TextureScale.y), 1);
	GetDevice()->SetVertexShaderConstantF(15, (float*)&ZEVector4(BlendTreshold * 2.0f * ChunkSize, (1.0f - BlendTreshold) * 2.0f * ChunkSize, 0.0f, 0.0f), 1);
	GetDevice()->SetVertexShaderConstantF(16, (float*)&ZEVector4(0.0f, 0.0f, 5.97f / (float)ColorTexture->GetWidth(), 8.77f / (float)ColorTexture->GetHeight()), 1);
	GetDevice()->SetVertexShaderConstantF(20, (float*)&RenderCommand->LocalMatrix, 4);

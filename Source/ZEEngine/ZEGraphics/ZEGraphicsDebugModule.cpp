...
#include "ZEUI/ZEUISceneStatisticsControl.h"
...
bool ZEGraphicsDebugModule::Initialize()
{
	...
	/*Map->SetMapFile("PortalDoorCullingMap.ZEMAP");*/
	...
	ZEUISceneStatisticsControl* SceneStats = new ZEUISceneStatisticsControl();
	zeGame->UIManager->AddControl(SceneStats);

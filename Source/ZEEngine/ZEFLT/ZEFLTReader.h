...
#pragma once
#ifndef __ZE_FLT_READER_H__
#define __ZE_FLT_READER_H__
...
{
	ZE_FLT_RECORD_UNUSED	= 0,
	ZE_FLT_RECORD_CONTROL	= 1,
	ZE_FLT_RECORD_PRIMARY	= 2,
	ZE_FLT_RECORD_ANCILLARY = 3
};

ZEPackStruct4(
struct ZEFLTRecordIdentifier
{
	ZEBigEndian<ZEInt16>	Opcode;
	ZEBigEndian<ZEUInt16>	Size;
};)

struct ZEFLTRecordHandler
{
	const char*				RecordName;
	ZEFLTRecordType			RecordType;
	ZEFLTRecordCallback		Callback;
};

...
/*******************************************************************************
 Zinek Engine - ZESteeringFlee.cpp
 ------------------------------------------------------------------------------
...
#include "ZESteeringFlee.h"
#include "ZEActor.h"

ZESteeringOutput ZESteeringFlee::Flee(const ZEVector3& Target)
{
...
ZESteeringOutput ZESteeringFlee::Process(float ElapsedTime)
{
	return Flee(GetTarget()->GetPosition());
}

ZESteeringFlee::ZESteeringFlee()
{
	SetPriority(3);
}

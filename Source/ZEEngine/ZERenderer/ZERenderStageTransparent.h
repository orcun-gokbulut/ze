...
/*******************************************************************************
 Zinek Engine - ZERenderStageTransparent.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef __ZE_RENDER_STAGE_TRANSPARENT_H__
#define __ZE_RENDER_STAGE_TRANSPARENT_H__
...
class ZERenderStageTransparent : public ZERenderStage
{
	protected:
		struct
		{

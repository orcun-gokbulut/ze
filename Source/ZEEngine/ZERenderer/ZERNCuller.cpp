...
ZEScene* ZESceneCuller::GetScene()
{
	return Scene;
}

void ZESceneCuller::SetCullParameters(const ZERNCullParameters& Parameters)
{
	CullParameters = Parameters;
}

const ZERNCullParameters& ZESceneCuller::GetCullParameters()
{

...
bool ZEJpegMainController::LoadHeader(ZETextureDataInfo* TextureDataInfo)
{
	...
	else
	{
		...
		{
			case 1:
				TextureDataInfo->PixelFormat = ZEGR_TF_R8_UNORM;
				break;
			
			case 3:
			case 4:
			default:
				TextureDataInfo->PixelFormat = ZEGR_TF_R8G8B8A8_UNORM;
				break;
		}
...
ZETextureData* ZEJpegMainController::LoadJpeg()
{
	...
	ZEGRFormat PixelFormat = Info.ComponentCount == 1 ? ZEGR_TF_R8_UNORM : ZEGR_TF_R8G8B8A8_UNORM;

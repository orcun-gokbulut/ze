...
#ifndef __ZE_MODEL_ANIMATION_BLENDER_H__
#define __ZE_MODEL_ANIMATION_BLENDER_H__
...
class ZEModelAnimationNodeBlend : public ZEModelAnimationNode
{
	protected:
		...
		ZEModelAnimationNode*				InputA;
		ZEModelAnimationNode*				InputB;
	...
	public:									
		...
		bool								SetInputA(ZEModelAnimationNode* Input);
		ZEModelAnimationNode*				GetInputA();
		bool								SetInputB(ZEModelAnimationNode* Input);
		ZEModelAnimationNode*				GetInputB();

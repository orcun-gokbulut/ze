...
void ZEModelResourceHelper::SetOwnerType(ZEModelResourceHelperOwnerType OwnerType)
{
	this->OwnerType = OwnerType;
}

ZEModelResourceHelperOwnerType ZEModelResourceHelper::GetOwnerType() const 
{
	return OwnerType;
}
...
bool ZEModelResourceHelper::Load(const ZEMLReaderNode& HelperNode)
{
	...
	SetOwnerType((ZEModelResourceHelperOwnerType)HelperNode.ReadInt32("OwnerType", ZE_MRHOT_MODEL));

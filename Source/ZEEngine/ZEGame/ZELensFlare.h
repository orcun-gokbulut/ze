...
class ZELensFlare : public ZEEntity
{
	...
	public:
		...
		const 
		ZEArray<ZELensFlareArtifact*>&		GetArtifacts();
		void								AddArtifact(ZELensFlareArtifact* Artifact);
		void								RemoveArtifact(ZELensFlareArtifact* Artifact);

...
/*******************************************************************************
 Zinek Engine - ZEUIHorizontalScrollbar.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef __ZE_UI_HORIZONTAL_SCROLL_BAR__
#define __ZE_UI_HORIZONTAL_SCROLL_BAR__

#include "ZEUI/ZEUIFrameControl.h"

class ZEUIRectangle;
class ZEUIScrollArea;
class ZEUIHorizontalScrollbar : public ZEUIControl
{
	private:
		...
		ZEUIFrameControl				ScrollbarLeftArrow;
		ZEUIFrameControl				ScrollbarRightArrow;
	...
	protected:
		...
		virtual void					ScrollbarLeftArrowPress(ZEUIMouseKey Button, const ZEVector2& MousePosition);
		virtual void					ScrollbarLeftArrowRelease(ZEUIMouseKey Button, const ZEVector2& MousePosition);

		virtual void					ScrollbarRightArrowPress(ZEUIMouseKey Button, const ZEVector2& MousePosition);
		virtual void					ScrollbarRightArrowRelease(ZEUIMouseKey Button, const ZEVector2& MousePosition);
	...
	public:
		...
		virtual void					SetMaterial(ZEMaterial* Material);
										...
										ZEUIHorizontalScrollbar(ZEUIScrollArea* Parent);
};

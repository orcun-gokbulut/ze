...
class ZEDSelectionManagerToolbar;
class Ui_ZEDMainWindow;

class ZEDMainWindow : public QMainWindow
{
	Q_OBJECT
	private:
		...
		ZEDSelectionManagerToolbar*			SelectionManagerToolbar;
		ZEDTransformationManagerToolbar*	TransformManagerToolbar;

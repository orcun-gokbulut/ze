...
/*******************************************************************************
 Zinek Engine - ZEDummyInputModuleDescription.cpp
 ------------------------------------------------------------------------------
...
int ZEDummyInputModuleDescription::GetRequiredZinekEngineVersion()
{
	return 0;
}

int ZEDummyInputModuleDescription::GetMajorVersion()
{
	return 0;
}

int ZEDummyInputModuleDescription::GetMinorVersion()
{
	return 1;
}

const char* ZEDummyInputModuleDescription::GetCopyright()
{
	return "Copyright (c) 2007-2009, Zinek Engine Group. All rights reserved.";
}

const char* ZEDummyInputModuleDescription::GetName()
{
	return "DummyInput";
}

ZEOptionSection* ZEDummyInputModuleDescription::GetOptions()
{
	return NULL;
}

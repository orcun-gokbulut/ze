...
/*******************************************************************************
 Zinek Engine - ZEFreespaceInputDeviceExtensionDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_FREESPACE_INPUT_DEVICE_EXTENSION_DESCRIPTION_H__
#define __ZE_FREESPACE_INPUT_DEVICE_EXTENSION_DESCRIPTION_H__

#include "ZECore\ZEExtensionDescription.h"

class ZEFreespaceInputDeviceExtensionDescription : public ZEExtensionDescription
{
	public:

...
/*******************************************************************************
 Zinek Engine - WindowsInputModule.cpp
 ------------------------------------------------------------------------------
...
void ZEDirectInputModule::ProcessInputMap(ZEInputMap* InputMap)
{
	...
	{
		CurrInputBinding = &InputMap->InputBindings.GetItem(I);
		switch(CurrInputBinding->Device)
		{
			case ZEINPUTBINDINGDEVICE_MOUSE:
				if (CurrInputBinding->Type == ZEINPUTBINDINGTYPE_AXIS)
				{
					if (CurrInputBinding->AxisSign == ZEINPUTAXIS_POSITIVE)
					{
						if (MouseState.Axis[CurrInputBinding->AxisId] > 0)
						{
							...
							InputMap->InputActions[InputMap->InputActionCount].AxisValue = MouseState.Axis[CurrInputBinding->AxisId];
							InputMap->InputActionCount++;
						}
					}
					else if (CurrInputBinding->AxisSign == ZEINPUTAXIS_NEGATIVE)
						if (MouseState.Axis[CurrInputBinding->AxisId] < 0)
						{
							InputMap->InputActions[InputMap->InputActionCount].Id = CurrInputBinding->ActionId;
							InputMap->InputActions[InputMap->InputActionCount].From =  CurrInputBinding;
				...
				else if (CurrInputBinding->Type == ZEINPUTBINDINGTYPE_BUTTON)
				{
					if (MouseState.Buttons[CurrInputBinding->ButtonId] & 0x80)
						{
							InputMap->InputActions[InputMap->InputActionCount].Id = CurrInputBinding->ActionId;
							InputMap->InputActions[InputMap->InputActionCount].From =  CurrInputBinding;
							InputMap->InputActionCount++;
			...
			case ZEINPUTBINDINGDEVICE_KEYBOARD:
			
				if (KeyboardState.Buttons[CurrInputBinding->ButtonId] & 0x80)
				{
					InputMap->InputActions[InputMap->InputActionCount].Id = CurrInputBinding->ActionId;
					InputMap->InputActions[InputMap->InputActionCount].From =  CurrInputBinding;
					InputMap->InputActionCount++;
			...
			case ZEINPUTBINDINGDEVICE_JOYSTICK:

				if (CurrInputBinding->Type == ZEINPUTBINDINGTYPE_AXIS)
				{	
					if (CurrInputBinding->AxisSign == ZEINPUTAXIS_POSITIVE)
					{
						if (JoystickState.Axis[CurrInputBinding->AxisId] > 0)
						{
							InputMap->InputActions[InputMap->InputActionCount].Id = CurrInputBinding->ActionId;
							InputMap->InputActions[InputMap->InputActionCount].From =  CurrInputBinding;
							InputMap->InputActions[InputMap->InputActionCount].AxisValue = JoystickState.Axis[CurrInputBinding->AxisId];
							InputMap->InputActionCount++;
						}
					}
					else if (CurrInputBinding->AxisSign == ZEINPUTAXIS_NEGATIVE)
					...
					if (JoystickState.Buttons[CurrInputBinding->ButtonId] & 0x80)
				if (JoystickState.Buttons[CurrInputBinding->ButtonId] & 0x80)
				{
					InputMap->InputActions[InputMap->InputActionCount].Id = CurrInputBinding->ActionId;
					InputMap->InputActions[InputMap->InputActionCount].From =  CurrInputBinding;
...
bool ZEDirectInputModule::GetKeyboardEntry(ZEKeyboardEntry& KeyboardEntry)
{
	return true;
}
 
bool ZEDirectInputModule::GetMouseEntry(ZEMouseEntry& MouseEntry)
{
	return true;
}
...
void ZEDirectInputModule::Destroy()
{
	if (DIMouse != NULL)
	{
		DIMouse->Unacquire();

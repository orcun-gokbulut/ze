...
void ZEGraphicsModule::BaseInitialize()
{
	...
	GraphicsOptions.AddOption(new ZEOption("NearZ", 0.001f, ZEOPTIONATTRIBUTE_INTERNAL));
	GraphicsOptions.AddOption(new ZEOption("FarZ", 16000.0f, ZEOPTIONATTRIBUTE_INTERNAL));

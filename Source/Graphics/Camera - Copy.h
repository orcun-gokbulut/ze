...
#include "DebugAsserts/DebugLineRenderer.h"
#include "Common/ZEMath/Plane.h"
#include "Common/ZEMath/BoundingVolume.h"
#include "Common/ZEMath/Rectangle.h"
#include "Common/ZEMath/GeometryUtils.h"
...
class ZECamera : public ZEComponent
{
	...
	public:
		void							SetNearZFarZ(float NearZ, float FarZ);
		void							GetNearFarZ(float& NearZ, float& FarZ);

...
/*******************************************************************************
 Zinek Engine - ZEPhysicsModuleDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_PHYSICS_MODULE_DESCRIPTION_H__
#define __ZE_PHYSICS_MODULE_DESCRIPTION_H__

#include "ZECore\ZEModuleDescription.h"

class ZEPhysicsModuleDescription : public ZEModuleDescription
{
	public:

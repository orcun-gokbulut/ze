...
/*******************************************************************************
 Zinek Engine - ZESocketTCPClient.h
 ------------------------------------------------------------------------------
...
class ZE_EXPORT_ZEFOUNDATION ZESocketTCPClient
{
	...
	private:
		...
		ZEUInt16					Port;
		ZESocketTCPClientStatus		Status;
	...
	public:
		...
		void						SetServerIPAddress(const ZEIPAddress& IPAddress);
		const ZEIPAddress&			GetServerIPAddress() const;

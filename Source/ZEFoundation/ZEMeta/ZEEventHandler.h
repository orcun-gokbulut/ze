...
#ifndef __ZE_EVENT_HANDLER_H__
#define __ZE_EVENT_HANDLER_H__
...
{
	public:
		virtual ZEMethodSignature& GetSignature() = 0;
};

template<typename TSignature>
class ZEEventHandler;

#define ZE_MACRO_INCLUDE_FILE_NAME "ZEMeta/ZEEventHandlerImp.h"

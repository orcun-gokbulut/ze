...
const char* ZEProperty::GetAttributeValue(const char* Name, ZESize Index, const char* DefaultValue) const
{
...
bool ZEProperty::CheckAttribute(const char* Name) const
{
	const ZEAttribute* Attribute = GetAttribute(Name);
	if (Attribute != NULL)
		return true;

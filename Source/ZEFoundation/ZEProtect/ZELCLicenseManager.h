...
class ZELCLicenseManager
{
	...
	public:
		...
		static ZEArray<ZELCLicense>		LoadLicenseFile(const ZEString& FileName);
		static bool						SaveLicenseFile(const ZEString& FileName, const ZEArray<ZELCLicense>& Licenses);
};

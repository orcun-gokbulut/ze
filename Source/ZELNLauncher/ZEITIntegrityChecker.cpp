...
/*******************************************************************************
 Zinek Engine - ZEITIntegrityChecker.cpp
 ------------------------------------------------------------------------------
...
void ZEITIntegrityCheker::SetIntegrityFile(const ZEString& FileName)
{
	IntegrityFile = FileName;
}

const ZEString& ZEITIntegrityCheker::GetIntegrityFile() const
{

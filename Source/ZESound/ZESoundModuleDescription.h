...
/*******************************************************************************
 Zinek Engine - ZESoundModuleDescription.h
 ------------------------------------------------------------------------------
...
#pragma once
#ifndef	__ZE_SOUND_MODULE_DESCRIPTION_H__
#define __ZE_SOUND_MODULE_DESCRIPTION_H__

#include "ZECore\ZEModuleDescription.h"

class ZESoundModuleDescription : public ZEModuleDescription
{
	public:

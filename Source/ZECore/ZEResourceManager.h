...
/*******************************************************************************
 Zinek Engine - ZEResourceManager.h
 ------------------------------------------------------------------------------
...
class ZEResourceManager
{
	private:
		friend ZEResource;
		ZESmartArray<ZEResource*>	SharedResources;
		ZEResource*					_GetResource(const char* FileName);
	...
	public:
		...
		void						UncacheResource(const char* FilenName);

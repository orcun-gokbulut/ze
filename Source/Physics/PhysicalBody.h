...
class ZEPhysicalBody
{
	protected:
									ZEPhysicalBody(){}
		virtual						~ZEPhysicalBody(){}

	public:
		virtual void				GetPhysicalObjectType();
		
		virtual	void				SetPhysicalBodyType() = 0;
		virtual ZEPhysicsBodyType	GetPhysicalBodyType() = 0;
		...
		virtual void				SetMassCenter(const ZEVector3& NewPosition) = 0;
		...
		virtual void				SetAngularVelocity(const ZEVector3&New Velocity) = 0;
		...
		virtual void				ApplyImpulse(const ZEVector3& Impulse) = 0;
		virtual void				ApplyTorque(const ZEVector3& Torque) = 0;

		virtual void				ApplyLocalForce(const ZEVector3& Force) = 0;
		virtual void				ApplyLocalImpulse(const ZEVector3& Impulse) = 0;
		...
		static ZEPhysicalBody*		CreateInstance();
};

...
bool ZEMaterial::SetupPreZPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderOrder) const
{
	return false;
}

bool ZEMaterial::SetupGBufferPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderOrder) const
{
	return false;
}

bool ZEMaterial::SetupForwardPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderOrder) const
{
	return false;
}

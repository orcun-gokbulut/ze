...
void ZED3D9HDRProcessor::OnDeviceLost()
{
	ReleaseRenderTargets();
}


void ZED3D9HDRProcessor::OnDeviceRestored()
{
...
void ZED3D9HDRProcessor::SetRenderTarget(LPDIRECT3DTEXTURE9 Texture)
{

...
bool ZED3D9TerrainMaterial::SetupGBufferPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderOrder) const
{
...
bool ZED3D9TerrainMaterial::SetupForwardPass(ZEFrameRenderer* Renderer, ZERenderCommand* RenderOrder) const
{
	// Update material if its changed. (Recompile shaders, etc.)
	((ZED3D9TerrainMaterial*)this)->UpdateMaterial();

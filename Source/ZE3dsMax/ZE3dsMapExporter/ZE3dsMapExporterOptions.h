...
/*******************************************************************************
 Zinek Engine - ZE3dsMapExporterOptions.h
 ------------------------------------------------------------------------------
...
enum ZEStartVolume
{
	ZESTARTVOLUME_CUBE = 0,
	ZESTARTVOLUME_CUBE_BASE = 1,
	ZESTARTVOLUME_CUBOID = 2
	
};

enum ZEHeuristics
{
	ZEHEURISTICS_PARTITIONEQUALLY = 0
};

class ZE3dsMapExporterOptions
{
	public:
		char				ZinekDir[MAX_PATH];
...
class ZEMapExporterOptionsDialog
{
	...
	private:
		...
		void					ManageDialog();
	public:
		bool					ShowDialog(HINSTANCE Instance, ZE3dsMapExporterOptions& Options);
};

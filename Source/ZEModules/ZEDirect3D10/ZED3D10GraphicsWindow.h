...
/*******************************************************************************
 Zinek Engine - ZED3D10GraphicsWindow.h
 ------------------------------------------------------------------------------
...
class ZED3D10RenderTarget;
class ZED3D10DepthStencilBuffer;

class ZED3D10GraphicsWindow : public ZEGraphicsWindow
{
	...
	protected:
		...
		ZED3D10RenderTarget*				BackBuffer;
		ZED3D10DepthStencilBuffer*			DepthBuffer;
		...
		bool								ManageFlagFullScreen();
											...
											ZED3D10GraphicsWindow();
		virtual								~ZED3D10GraphicsWindow();

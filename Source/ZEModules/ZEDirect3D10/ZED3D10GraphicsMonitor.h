...
/*******************************************************************************
 Zinek Engine - ZED3D10GraphicsMonitor.h
 ------------------------------------------------------------------------------
...
class ZED3D10GraphicsMonitor : public ZEGraphicsMonitor
{
	...
	protected:
		...
		ZEArray<DXGI_MODE_DESC1>		DXGIModes;
										...
										ZED3D10GraphicsMonitor(IDXGIOutput1* Output, IDXGIAdapter2* OwnerAdapter);
		virtual							~ZED3D10GraphicsMonitor();

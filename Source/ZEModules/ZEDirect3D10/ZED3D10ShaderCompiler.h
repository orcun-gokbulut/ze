...
/*******************************************************************************
 Zinek Engine - ZED3D10ShaderCompiler.h
 ------------------------------------------------------------------------------
...
class ZEShader;
class ZED3D10Shader;
class ZED3D10PixelShader;
class ZED3D10VertexShader;
class ZED3D10GeometryShader;

class ZED3D10ShaderCompiler : public ZEShaderCompiler, public ZED3D10ComponentBase
{
	...
	protected:
		...
		ZEShader*					CompileShader(ZEShaderCompileOptions* Options);
									...
									ZED3D10ShaderCompiler();
		virtual						~ZED3D10ShaderCompiler();
};

...
extern "C"
{
	ZE_EXPORT_ZEDIRECT3D11 ZEPlugin* zeCreatePluginInstance();
};

class ZE_EXPORT_ZEDIRECT3D11 ZED11Plugin : public ZEPlugin
{
	ZE_DISALLOW_COPY(ZED11Plugin)

...
class ZED3D11Shader : public ZEGRShader
{
	...
	protected:	
		ID3DBlob*					D3D10ByteCode;
									...
									ZED3D11Shader(ID3DBlob* ByteCode);
		virtual						~ZED3D11Shader();
...
class ZED3D11PixelShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11PixelShader*			D3D10PixelShader;
									...
									ZED3D11PixelShader(ID3DBlob* ByteCode, ID3D11PixelShader*	PixelShader);
...
class ZED3D11VertexShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11VertexShader*			D3D10VertexShader;
									...
									ZED3D11VertexShader(ID3DBlob* ByteCode, ID3D11VertexShader* VertexShader);
...
class ZED3D11GeometryShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11GeometryShader*		D3D10GeometryShader;
									...
									ZED3D11GeometryShader(ID3DBlob* ByteCode, ID3D11GeometryShader* GeometryShader);
...
class ZED3D11DomainShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11DomainShader*			D3D10DomainShader;
									...
									ZED3D11DomainShader(ID3DBlob* ByteCode, ID3D11DomainShader* DomainShader);
...
class ZED3D11HullShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11HullShader*			D3D10HullShader;
									...
									ZED3D11HullShader(ID3DBlob* ByteCode, ID3D11HullShader* HullShader);
...
class ZED3D11ComputeShader : public ZED3D11Shader, private ZED3D11ComponentBase
{
	...
	protected:
		ID3D11ComputeShader*		D3D10ComputeShader;
									...
									ZED3D11ComputeShader(ID3DBlob* ByteCode, ID3D11ComputeShader* ComputeShader);

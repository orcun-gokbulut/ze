...
/*******************************************************************************
 Zinek Engine - ZED3D9SeaMaterial.h
 ------------------------------------------------------------------------------
...
class ZED3D9SeaMaterial : public ZESeaMaterial, public ZED3D9ComponentBase
{
	friend class ZED3D9Module;

	private:
		ZED3D9VertexShader*				ForwardPassVertexShader;
		ZED3D9VertexShader*				GPassVertexShader;
		
		ZED3D9PixelShader*				ForwardPassPixelShader;
		ZED3D9PixelShader*				GPassPixelShader;

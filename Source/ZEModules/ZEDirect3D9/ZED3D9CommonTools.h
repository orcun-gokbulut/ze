...
class ZED3D9CommonTools : public ZED3D9ComponentBase
{
	public:
		...
		static bool				CompileVertexShaderFromMemory(LPDIRECT3DVERTEXSHADER9* VertexShader, const char* Source, const char* MainFunction, const char* ShaderProfile, ZEUInt32 Components = 0);
		static bool				CompilePixelShaderFromMemory(LPDIRECT3DPIXELSHADER9* PixelShader, const char* Source, const char* MainFunction, const char* ShaderProfile, ZEUInt32 Components = 0);

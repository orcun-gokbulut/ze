...
void ZECIM::DeInitialize()
{
	CoUninitialize();
}

bool ZECIM::ExecuteQuery(ZEString& Output, const ZEString& NameSpace, const ZEString& Language, const ZEString& Query)
{
	HRESULT			hResult;

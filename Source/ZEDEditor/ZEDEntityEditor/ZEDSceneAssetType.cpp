...
{
	static ZEVector3 Color(0.957f, 0.263f, 0.212f);
	return Color;
}

const char* ZEDSceneAssetType::GetIconPath(const ZEString& Extension) const
{
	return "#R:/ZEDEditor/Icons/ZEDAsset/ZEDSceneAsset.png";
}
